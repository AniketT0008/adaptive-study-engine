...
import { getDueConcepts, selectNextQuestion, updateConceptAfterAnswer } from '../engine/adaptive.js';
...
export default function ReviewSession() {
  ...
  const initQueue = useCallback((loadedDeck) => {
    ...
    // Build question queue: select one question per due concept
    const q = [];
  ...
  const handleAnswer = useCallback((isCorrect, question) => {
    ...
    const updatedConcept = updateConceptAfterAnswer(conceptBefore, isCorrect, question.difficulty);
