        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {deck.concepts?.map((concept, index) => {
            ...
            return (
              <div
                key={concept.id}
                className="glass p-5 rounded-xl transition-all duration-300 animate-slide-up hover:scale-[1.02] border border-white/[0.06] hover:border-[var(--color-accent)]/40 flex flex-col justify-between"
